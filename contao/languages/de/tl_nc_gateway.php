...
use Softleister\ContaoPdfGatewayBundle\Gateway\ContaoPdfGatewayGateway;


/**
 * Fields
 */
$GLOBALS['TL_LANG']['tl_nc_gateway']['type'][ContaoPdfGatewayGateway::NAME] = 'PDF Gateway';
 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_nc_gateway']['positions']  = array('Positionen', "Definition der Textpositionen im PDF \ncontao-pdf-gateway-bundle V " . InstalledVersions::getPrettyVersion('do-while/contao-pdf-gateway-bundle'));
 
/**
 * Legends
 */
$GLOBALS['TL_LANG']['tl_nc_gateway']['title_legend']   = 'PDF Gateway';
$GLOBALS['TL_LANG']['tl_nc_gateway']['datei_legend']   = 'Einstellungen PDF-Datei';
$GLOBALS['TL_LANG']['tl_nc_gateway']['vorlage_legend'] = 'Einstellungen zur Vorlage';
$GLOBALS['TL_LANG']['tl_nc_gateway']['font_legend']    = 'Schriftarten';
$GLOBALS['TL_LANG']['tl_nc_gateway']['protect_legend'] = 'PDF-Schutz';
